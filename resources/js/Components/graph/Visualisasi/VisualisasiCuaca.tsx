...
import { addWaktuAttribute, filterDataByRangeYearAndTerritory, getLegendData } from "@/lib/utils";
...
export const VisualisasiCuaca = ({
    ...
    const groupByYear = (data: any[], variable: string) => {
        return data.reduce((acc, item) => {
            ...
            const ageGroupKey = item.bulan; // Key by bulan
            const value = item[variable]; // Get the value of the specified variable
    ...
    }, [filteredData, activeState, activeVariable])
